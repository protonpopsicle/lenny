...
async function speak() {    
    const templates = [
        () => `It seems that you have been living two lives. In one life, you are ${toTitleCase(n())}, ${n()} ${v(2)} for a respectable ${n()} company. You have a ${n()}, you ${v()} your ${n()} and you help your land lady ${v()} her ${n()}.`,
        ...
        () => `${toTitleCase(n())} ${['II', 'III', 'IV', 'V', 'VI'][Math.floor(Math.random() * 5)]}: The Sequel to ${toTitleCase(n())}`,
        ...
        () => `The ${n()} of Shokam's ${adj()} ${n()} let loose on top of ${toTitleCase(n())} creek. Blood ${v(1)} down on the soldiers as they ${v(1)} in their huts. "${toTitleCase(n())}", said the Lieutenant.`,
        () => `I've seen ${n(true)} you people wouldn't believe. ${adj()} ${n(true)} on fire off the ${n()} of Orion. I watched C-${n(true)} ${v()} in the dark near the ${toTitleCase(n())}häuser Gate. All those moments will be lost in time, like tears in the ${n()}. Time to die.`,
        ...
        () => `The question is in a way ${adj()}, she ${v(3)}, but one must ask. ${toTitleCase(n())} in such situations is rarely ${adj()}. Sex is the engine, exalting and ruining people, sex and frustration. ${toTitleCase(n())} is what people believe is worth the path of devastation.`
    ];
